...
if(res.data.success == false){
  ...
  return (
   <>
   <div className='m-4'>
    <h3>Editing Product for - <span className='text-danger'>{productName}</span></h3>
    <div className='d-flex gap-3'>
      ...
      <label>Product Name</label>
        ...
        <input value={productPrice}onChange={(e)=>setProductPrice(e.target.value)}className='form-control mb-2' type='number' name="" id="" placeholder='Enter your price'/>
      ...
      <img  src={oldImage} alt=''className='img-fluid rounded-4 object-fit-cover'  width={300} height={300}/>
